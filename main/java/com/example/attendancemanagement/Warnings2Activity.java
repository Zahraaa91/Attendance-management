...
public class Warnings2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warnings2);
    ...
    protected void onStart() {
        ...
        databaseArtists.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                ArtistLists artistAdapter = new ArtistLists(Warnings2Activity.this, artistss);
